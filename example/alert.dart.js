...
$$.JSArray = {"": "Object;",
  ...
  map$1: function(receiver, f) {
    return $.MappedIterable$(receiver, f);
  },
...
$$.Alert = {"": "Object;_targetElementID",
  alert$2: function(message, options) {
    ...
    divElement = $._ElementFactoryProvider_createElement_html(this._buildAlertDiv$2(message, options));
  ...
  clear$0: function() {
    ...
    if ($parent == null)
      throw $.$$throw($._ExceptionImplementation$("Target Not Found. [" + t2 + "]"));
    $.clear($parent.get$children());
  },
  _buildAlertDiv$2: function(message, options) {
    var opts = $.JsStringBuffer$("");
    opts.add$1("alert fade in");
    $.CONSTANT2.forEach$1(options, new $.Alert__buildAlertDiv_anon(opts));
    return "<div class=\"" + $.S(opts.toString$0()) + "\">\n  <button type=\"button\" class=\"close\" data-dismiss=\"alert\">\u00d7</button>\n  " + message + "\n</div>\n";
  }
};

$$.main_anon = {"": "Closure;alert_0",
  call$1: function(_) {
    this.alert_0.alert$2("<h4>WARNING</h4>warning, warning, warning, warning", ["alert-block", ""]);
  }
};

$$.main_anon0 = {"": "Closure;alert_1",
  call$1: function(_) {
    this.alert_1.alert$2("<h4>ERROR</h4>error, error, error, error.", ["alert-block", "alert-error"]);
  }
};

$$.main_anon1 = {"": "Closure;alert_2",
  call$1: function(_) {
    var divAlert = this.alert_2.alert$2("<h4>SUCCESS</h4>success, success, success", ["alert-block", "alert-success"]);
    window.setTimeout$2(new $.main__anon0(divAlert), 3000);
  }
};

$$.main__anon0 = {"": "Closure;divAlert_3",
  call$0: function() {
    this.divAlert_3.remove$0();
  }
};

$$.main_anon2 = {"": "Closure;alert_4",
  call$1: function(_) {
    var divAlert = this.alert_4.alert$2("<h4>INFO</h4>info, info, info, info, info", ["alert-block", "alert-info"]);
    window.setTimeout$2(new $.main__anon(divAlert), 3000);
  }
};

$$.main__anon = {"": "Closure;divAlert_5",
  call$0: function() {
    this.divAlert_5.remove$0();
  }
};

$$.main_anon3 = {"": "Closure;alert_6",
  call$1: function(_) {
    $.clear(this.alert_6);
  }
};
...
$$.Alert__buildAlertDiv_anon = {"": "Closure;opts_0",
  call$1: function(val) {
...
$._FutureImpl__FutureImpl$wait = function(futures) {
  ...
  if (t2.get$isEmpty(futures) === true)
    return $._FutureImpl$immediate($.CONSTANT9);
  completer = $._CompleterImpl$();
...
$.main = function() {
  ...
  document.query$1("#warning").get$onClick().listen$1(new $.main_anon($alert));
  document.query$1("#error").get$onClick().listen$1(new $.main_anon0($alert));
  document.query$1("#success").get$onClick().listen$1(new $.main_anon1($alert));
  document.query$1("#info").get$onClick().listen$1(new $.main_anon2($alert));
  document.query$1("#clear").get$onClick().listen$1(new $.main_anon3($alert));
};

$.Alert$ = function(_targetElementID) {
  return new $.Alert(_targetElementID);
};
...
$.CONSTANT6 = new Isolate.$isolateProperties.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, Isolate.$isolateProperties.CONSTANT10);
...
$.CONSTANT7 = new Isolate.$isolateProperties.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, Isolate.$isolateProperties.CONSTANT11);
...
// 18 !leaf
(function() {
  var v0_MediaElement = "HTMLMediaElement|HTMLVideoElement|HTMLAudioElement", v1_SvgElement = "SVGElement|SVGStyledElement|SVGAElement|SVGTextContentElement|SVGTextPositioningElement|SVGAltGlyphElement|SVGTRefElement|SVGTSpanElement|SVGTextElement|SVGTextPathElement|SVGCircleElement|SVGClipPathElement|SVGDescElement|SVGEllipseElement|SVGFEColorMatrixElement|SVGFEConvolveMatrixElement|SVGFEComponentTransferElement|SVGFECompositeElement|SVGFEDisplacementMapElement|SVGFEFloodElement|SVGDefsElement|SVGFEBlendElement|SVGFEImageElement|SVGFEDropShadowElement|SVGFEMergeElement|SVGFESpecularLightingElement|SVGFEMorphologyElement|SVGFEDiffuseLightingElement|SVGFEGaussianBlurElement|SVGFETurbulenceElement|SVGFilterElement|SVGGElement|SVGForeignObjectElement|SVGFETileElement|SVGFEOffsetElement|SVGImageElement|SVGGlyphRefElement|SVGLineElement|SVGMaskElement|SVGGradientElement|SVGLinearGradientElement|SVGRadialGradientElement|SVGPathElement|SVGMarkerElement|SVGPatternElement|SVGMissingGlyphElement|SVGPolygonElement|SVGPolylineElement|SVGRectElement|SVGStopElement|SVGSVGElement|SVGSwitchElement|SVGSymbolElement|SVGTitleElement|SVGUseElement|SVGAltGlyphDefElement|SVGAltGlyphItemElement|SVGAnimationElement|SVGAnimateColorElement|SVGAnimateElement|SVGAnimateMotionElement|SVGAnimateTransformElement|SVGSetElement|SVGComponentTransferFunctionElement|SVGFEFuncAElement|SVGFEFuncBElement|SVGFEFuncRElement|SVGFEFuncGElement|SVGCursorElement|SVGFESpotLightElement|SVGFEMergeNodeElement|SVGFEPointLightElement|SVGFontFaceNameElement|SVGFontFaceElement|SVGGlyphElement|SVGFontFaceSrcElement|SVGMPathElement|SVGFontFaceUriElement|SVGFontElement|SVGFontFaceFormatElement|SVGMetadataElement|SVGHKernElement|SVGFEDistantLightElement|SVGScriptElement|SVGStyleElement|SVGVKernElement|SVGViewElement", v2_Element = [v0_MediaElement, v1_SvgElement, "Element|HTMLProgressElement|HTMLQuoteElement|HTMLScriptElement|HTMLSelectElement|HTMLShadowElement|HTMLSourceElement|HTMLSpanElement|HTMLStyleElement|HTMLTableCaptionElement|HTMLTableCellElement|HTMLTableColElement|HTMLTableElement|HTMLTableRowElement|HTMLTableSectionElement|HTMLTextAreaElement|HTMLTitleElement|HTMLTrackElement|HTMLUListElement|HTMLUnknownElement|HTMLAppletElement|HTMLBaseFontElement|HTMLDirectoryElement|HTMLFontElement|HTMLFrameElement|HTMLFrameSetElement|HTMLMarqueeElement|HTMLElement|HTMLAnchorElement|HTMLAreaElement|HTMLBRElement|HTMLBaseElement|HTMLBodyElement|HTMLButtonElement|HTMLCanvasElement|HTMLContentElement|HTMLDListElement|HTMLDataListElement|HTMLDetailsElement|HTMLDivElement|HTMLEmbedElement|HTMLFieldSetElement|HTMLFormElement|HTMLHRElement|HTMLHeadElement|HTMLHeadingElement|HTMLHtmlElement|HTMLIFrameElement|HTMLImageElement|HTMLInputElement|HTMLKeygenElement|HTMLLIElement|HTMLLabelElement|HTMLLegendElement|HTMLLinkElement|HTMLMapElement|HTMLMenuElement|HTMLMetaElement|HTMLMeterElement|HTMLModElement|HTMLOListElement|HTMLObjectElement|HTMLOptGroupElement|HTMLOptionElement|HTMLOutputElement|HTMLParagraphElement|HTMLParamElement|HTMLPreElement"].join("|"), v3_DocumentFragment = "DocumentFragment|ShadowRoot", v4_CharacterData = "CharacterData|Text|CDATASection|Comment", v5_Document = "Document|SVGDocument|HTMLDocument", v6_Node = [v2_Element, v3_DocumentFragment, v4_CharacterData, v5_Document, "Node|ProcessingInstruction|Attr|DocumentType|EntityReference|Notation"].join("|");
  $.dynamicSetMetadata([["HTMLMediaElement", v0_MediaElement], ["Document", v5_Document], ["DocumentFragment", v3_DocumentFragment], ["HTMLCollection", "HTMLCollection|HTMLFormControlsCollection|HTMLOptionsCollection"], ["Uint8Array", "Uint8Array|Uint8ClampedArray"], ["CharacterData", v4_CharacterData], ["SVGElement", v1_SvgElement], ["Element", v2_Element], ["Node", v6_Node], ["NodeList", "NodeList|RadioNodeList"], ["EventTarget", [v6_Node, "EventTarget|DOMWindow"].join("|")]]);
})();
