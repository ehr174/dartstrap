...
$$._FrozenElementList = {"": "Object;_nodeList",
  ...
  $index: function(index) {
    ...
    if (typeof t1 !== "string" && (typeof t1 !== "object" || t1 === null || t1.constructor !== Array && !t1.$isJavaScriptIndexingBehavior()))
      return this.$$index$bailout0(1, t1, index);
    if (index !== (index | 0))
      throw $.iae(index);
    if (index < 0 || index >= t1.length)
      throw $.ioore(index);
  ...
  $$index$bailout0: function(state0, t1, index) {
    return $.$$index(t1, index);
  },
  $indexSet: function(index, value) {
    throw $.$$throw($.UnsupportedError$(""));
...
$$.Progress = {"": "Object;_targetElementID,_divCurrent,_percent",
  get$percent: function() {
    return this._percent;
  },
  set$percent: function(val) {
    this._percent = val;
    this._onPercentChanged$1(val);
  },
  show$1: function(options) {
    ...
    divElement = $._ElementFactoryProvider_createElement_html(this._buildProgressDiv$2(this.get$percent(), options));
    t1 = this._divCurrent;
    if (!(t1 == null)) {
      t1.remove$0();
      this._divCurrent = null;
    }
    $.add($parent.get$nodes(), divElement);
    this._divCurrent = divElement;
    return divElement;
  },
  _buildProgressDiv$2: function(percent, options) {
    var opts = $.JsStringBuffer$("");
    opts.add$1("progress");
    $.forEach(options, new $.Progress__buildProgressDiv_anon(opts));
    return "  <div class=\"" + $.S(opts.toString$0()) + "\">\n    <div class=\"bar\" style=\"width: " + $.S(percent) + "%;\"></div>\n  </div>\n";
  },
  _onPercentChanged$1: function(percent) {
    var t1 = this._divCurrent;
    if (t1 == null)
      return;
    $.$$indexSet($.$$index(t1.get$nodes(), 1).get$attributes(), "style", "width: " + $.S(percent) + "%;");
  }
};

$$.main_anon = {"": "Closure;",
  call$1: function(handler) {
    var t1 = $.int_parse(handler.get$currentTarget().get$value(), null, null);
    $.get$progress().set$percent(t1);
  }
};
...
$$.main_anon2 = {"": "Closure;",
  call$1: function(element) {
    element.get$onClick().listen$1(new $.main__anon());
  }
};
...
$$.Progress__buildProgressDiv_anon = {"": "Closure;opts_0",
  call$1: function(val) {
...
$._ElementFactoryProvider_createElement_html = function(html) {
  ...
  if (!(match == null)) {
    ...
    if ($._Device_isOpera() !== true && $.contains($._Device_userAgent(), "MSIE", 0) === true && $.CONSTANT7.containsKey$1(tag) === true)
...
$.main = function() {
  $.get$progress().set$percent(30);
  $.get$progress().show$1([]);
  document.query$1("#selectPercent").get$onChange().listen$1(new $.main_anon());
  document.query$1("#chkStriped").get$onClick().listen$1(new $.main_anon0());
  document.query$1("#chkActive").get$onClick().listen$1(new $.main_anon1());
  $.forEach(document.queryAll$1("[name=\"optionsRadios\"]"), new $.main_anon2());
};

$._getOptions = function() {
  var options = $.List_List(0);
  if ($.$$eq(document.query$1("#chkStriped").get$checked(), true) === true)
    options.push("progress-striped");
  if ($.$$eq(document.query$1("#chkActive").get$checked(), true) === true)
    options.push("active");
  if ($.$$eq(document.query$1("#radioInfo").get$checked(), true) === true)
    options.push("progress-info");
  if ($.$$eq(document.query$1("#radioSuccess").get$checked(), true) === true)
    options.push("progress-success");
  if ($.$$eq(document.query$1("#radioWarning").get$checked(), true) === true)
    options.push("progress-warning");
  if ($.$$eq(document.query$1("#radioDanger").get$checked(), true) === true)
    options.push("progress-danger");
  return options;
};

$.Progress$ = function(_targetElementID) {
  return new $.Progress(_targetElementID, null, null);
};
...
$.CONSTANT7 = new Isolate.$isolateProperties.ConstantMap(9, {caption: null, col: null, colgroup: null, tbody: null, td: null, tfoot: null, th: null, thead: null, tr: null}, Isolate.$isolateProperties.CONSTANT11);
...
$.CONSTANT8 = new Isolate.$isolateProperties.ConstantMap(12, {body: "html", head: "html", caption: "table", td: "tr", th: "tr", colgroup: "table", col: "colgroup", tr: "tbody", tbody: "table", tfoot: "table", thead: "table", track: "audio"}, Isolate.$isolateProperties.CONSTANT12);
...
Isolate.$lazy($, "progress", "progress", "get$progress", function() {
...
//@ sourceMappingURL=progress.dart.js.map
